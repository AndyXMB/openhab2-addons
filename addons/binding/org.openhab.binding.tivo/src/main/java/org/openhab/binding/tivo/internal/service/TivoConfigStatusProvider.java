...
public class TivoConfigStatusProvider {
    ...
    private TivoStatusData parseStatus(String strTivoStatus) {
        ...
        if (strTivoStatus == null) {
            ...
            switch (strTivoStatus) {
                ...
                case "CH_FAILED NO_LIVE":
                    return new TivoStatusData(false, -1, "CH_FAILED NO_LIVE", true, ConnectionStatus.ONLINE);
        ...
        if (matcher.find()) {
            ...
            return new TivoStatusData(true, chNum, strTivoStatus, true, ConnectionStatus.ONLINE);
        }
    ...
    private boolean testConnection() {
        ...
        if (getOk & sendOk) {
            ...
            tivoStatusData.setConnectionStatus(ConnectionStatus.TESTFAIL);
            return false;
        }
    }
